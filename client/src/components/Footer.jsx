            ...
            <div className="flex flex-col">
                ...
                <div className="flex flex-col mt-4 md:mt-0 md:flex-row">
                    ...
                    <div className="flex items-center justify-center flex-1 mt-4 border-[#1e1e28] md:mt-0 md:border-r">
                        <a className="hover:text-primary-gray-20" href="https://github.com/Aarav290-arch" target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="flex flex-col items-center justify-center flex-1 mt-7 md:mt-0 md:items-start md:pl-5">
                        ...
                        <span className="mt-7 md:mt-1">
                            By <a className="underline hover:text-primary-gray-20" href="https://github.com/Aarav290-arch" target="_blank" rel="noopener noreferrer">Aarav290-arch</a>
                        </span>
                    </div>
                </div>
            </div>
